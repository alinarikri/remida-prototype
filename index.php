<?php require 'includes/header.php'; ?>
   ...
   <div id="front-section">
          ...
          <div class="small-11 large-8 columns end">
    ...
    <div id="second-section">
          <div class="row">
                <div class="small-11 medium-4 large-4 columns border-top card">
                    <h2>Workshops</h2>
            ...
            <div class="small-11 medium-4 large-4 columns end border-top card ">
            <h2>For companies</h2>
   ...
   <div id="fourth-section">
        <div class="row">
            <div class="small-11 large-8 columns">
                ...
                <p><a href="">What call to action here???</a></p>
            </div>
    </div>
 </div> 
